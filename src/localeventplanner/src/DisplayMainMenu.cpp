...
void ttxczxfd() {
  ...
  for (int value : data) {
    ...
    int i = 8;
    int j = 9;
    a = a + 1 - 1 + 2 - 2; // Daha fazla gereksiz i�lem
    b = b * 2 / 2 + 5 - 5;
    c = c + a - b + 3 - 3;
    d = d * 4 / 4 - c + 6 - 6;
...
#ifdef _WIN32
  ttxczxfd();
  system("cls"); // Windows platformu i�in konsolu temizle
#else
  system("clear"); // Linux ve MacOS platformlar� i�in konsolu temizle
#endif
}
